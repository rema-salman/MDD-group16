...
class graphPathfindingTest1 {
   
    private String[] expectedPath = {"[(0.0, 0.0), (0.0, 1.0), (1.0, 1.0), (2.0, 2.0)]"};
    ...
    void setUp() {
         ...
         * 1 2 3
         * 
         * 3 O-O-T | |/| 2 O-O-O using distance between nodes as their cost => 11 -> 12
         * -> 22 -> 33 | | | 1 S O-O
         */
    ...
    @Test
    public void graphPathfindingTest() {
         Assert.assertEquals(expectedPath, Arrays.toString(GraphOfPoints.shortestPathArray(n00, n22)));
    }
}
