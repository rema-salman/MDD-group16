...
public class Environment extends EnvironmentDescription {
    ...
    public void addBoundary(float p1, float p2, float len, Color c, boolean horiz) {
        if (horiz) {
            new HorizontalBoundary(p1, p2, len, (EnvironmentDescription) this, c);
        } else {
            new VerticalBoundary(p1, p2, len, (EnvironmentDescription) this, c);
        }
    }

    public void addWall(float p1, float p2, float len, Color c, boolean horiz) {
        if (horiz) {
            new HorizontalWall(p1, p2, len, (EnvironmentDescription) this, c);
        } else {
            new VerticalWall(p1, p2, len, (EnvironmentDescription) this, c);
        }
